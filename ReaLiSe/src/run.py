...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name_or_path",
                        default='/data/dobby_ceph_ir/neutrali/pretrained_models/roberta-base-ch-for-csc', type=str,
                        help="Path to pre-trained model or shortcut name selected in the list: " + ", ".join(
                            ALL_MODELS))
    parser.add_argument("--font_path", default='/data/dobby_ceph_ir/neutrali/experiments/spell-acl/simhei.ttf',
                        type=str)
